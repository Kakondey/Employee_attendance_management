<?php
    ...
    if (isset($_POST['Add'])) {
        ...
        $sql = "INSERT INTO leave_type(type)
                 VALUES ('$type')";    

        if (mysqli_query($conn, $sql)) 
        {
            $successmsz = 'Leave Type is successfully Entered.';
            header('refresh:1; url=Add_leave_type.php');
        }
        else
        {
                    ...
                    <div class="content"> 
                        <div class="module">
                            <div class="module-head">
                                <center><h3>Add Leave Type</h3></center>
                            </div>
                            <div class="module-body">
                                    ...
                                    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" class="form-horizontal row-fluid" >
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="type" name="type" class="span8"><br><br>
                                            </div>
                                        </div>
