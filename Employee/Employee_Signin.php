<?php
	...
	if (isset($_POST['login'])) {
		...
		if ($count == 1 && $row['Employee_Password'] = $Employee_Password) {
			session_start();
			$_SESSION['Employee_name'] = $row['Employee_name'];
			header("refresh:1; url=Employee_Dashboard.php");
		}
		else{
		...
		<div class="navbar-inner">
			<div class="container">
				<a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
			  	...
			  	<a class="brand" href="#">
			  		Employee Management System(Employee Section)
			  	</a>
				...
				<div class="nav-collapse collapse navbar-inverse-collapse">
					...
					<ul class="nav pull-right">
						...
						<li><a href="forms/Employee_Signup.php">
							Signup
						</a></li>
					</ul>
				</div><!-- /.nav-collapse -->
										...
										<?php
                                            if(isset($errormsg))
                                            {
                                              ...
                                              <div class="alert alert-error">
                                                ...
                                                <a href="Employee_Signin.php"><?php echo $errormsg; ?><a/> 
                                              </div>
                                              <?php
                                            }
                                        ?>
